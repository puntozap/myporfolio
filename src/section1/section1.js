                ...
                <Container>
                    <Row>
                        ...
                        <Col lg={8} className="text-center"><img className="rounded-circle border-white" src={logo} width={200} />
                            ...
                            <p className="text-white text-uppercase"><a className="text-white" href="https://www.instagram.com/puntozap/" target="_blank"><i className="fab fa-instagram"></i> puntozap</a> | <i className="fab fa-whatsapp"></i> +58 424 7647893 | <i className="fas fa-envelope-square"></i> puntozap@gmail.com</p>
