            ...
            <Row>
                <Col sm="12" className="pt-5" >
                    ...
                    <p className="text-justify text-monospace">
                        I have been programming for 7 years in professional academic mode and 3 years experience in small and big companies around the world, with a company named VILLARTECHNOLOGIES.</p>
                    <p className="text-justify text-monospace">During that time, I developed in Backend, however, I 💓 frontend, because, there is nothing like a tech perfect product from the visual point of view, Therefore, I consider an integral person, because I like as the backend as the frontend.  There is not like the  creative or simples  desing ideas in any web project</p>
                    <hr/>
