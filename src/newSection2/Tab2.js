            ...
            <Row>
                <Col sm="12" className="pt-5" >
                    ...
                    <p className="text-justify text-monospace">
                        I have been programming for 10 years in professional academic mode and 4 years experience in small and big companies around the world, with a company named VILLARTECHNOLOGIES.</p>
